    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-grow">
        ...
        <main className="flex-grow p-8 bg-gradient-to-r from-blue-50 to-blue-100">
          <h2 className="text-4xl font-bold mb-6 text-gray-800">Welcome to the {projectName} Project</h2> {/* Display the project name */}
          ...
          <p className="text-gray-500">Get started by selecting a dataset or creating a label!</p>
          <div className="mt-8">
